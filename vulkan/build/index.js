...
server.resource("vulkan-site-index", "vulkan-site-index", () => {
    return {
        contents: [
            {
...
server.tool("search-vulkan-docs", "Search Vulkan documentation for specific topics", {
...
server.tool("get-vulkan-topic", "Get information about a specific Vulkan topic", {
